	...
	computed: {
		...
		mediaConstraintsStyle() {
			...
			const style = {
				...
				'--mobile-media-height': this.stageStreamCollapsed ? '56px' : hasChatbar ? 'min(56.25vw, calc(40vh))' : (hasStageTools ? 'calc(var(--vh100) - 48px - 2 * 56px)' : 'calc(var(--vh100) - 48px - 56px)'),
			...
			if (this.mediaSourcePlaceholderRect) {
				...
				Object.assign(style, {
					...
					'--mediasource-placeholder-height': fullHeight + 'px',
