...
class SubEventsTest(SoupTest):
    ...
    def test_create(self):
        ...
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/add',
            {
                'name_0': 'SE2',
                'active': 'on',
    ...
    def test_modify(self):
        ...
        assert doc.select('input[name=quotas-TOTAL_FORMS]')
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/%d/' % self.subevent1.pk,
            {
                'name_0': 'SE2',
                'active': 'on',
                'date_from_0': '2017-07-01',
    ...
    def test_delete_with_orders(self):
        ...
        doc = self.get_doc(
            '/control/event/ccc/30c3/subevents/%d/delete' % self.subevent1.pk,
            follow=True,
        )
    ...
    def test_create_bulk(self):
        ...
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/bulk_add',
            {
    ...
    def test_delete_bulk(self):
        ...
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/bulk_action',
            {
    ...
    def test_delete_bulk_by_query(self):
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/bulk_action',
            {'__ALL': 'on', 'filter-query': 'SE2', 'action': 'delete_confirm'},
            follow=True,
        )
        assert doc.select('.alert-success')
        with scopes_disabled():
    ...
    def test_disable_bulk(self):
        ...
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/bulk_action',
            {'subevent': str(self.subevent2.pk), 'action': 'disable'},
            follow=True,
        )
        assert doc.select('.alert-success')
        with scopes_disabled():
    ...
    def test_enable_bulk(self):
        ...
        doc = self.post_doc(
            '/control/event/ccc/30c3/subevents/bulk_action',
            {'subevent': str(self.subevent2.pk), 'action': 'enable'},
            follow=True,
        )
        assert doc.select('.alert-success')
        with scopes_disabled():
    ...
    def test_edit_bulk_meta(self):
        ...
        assert doc.select('.alert-success')
        with scopes_disabled():
            assert self.event1.subevents.get(pk=self.subevent1.pk).meta_data == {
                'Prop1': 'Bla',
                'Prop2': '',
            }
            assert self.event1.subevents.get(pk=self.subevent2.pk).meta_data == {
                'Prop1': 'Bla',
                'Prop2': '',
            }
